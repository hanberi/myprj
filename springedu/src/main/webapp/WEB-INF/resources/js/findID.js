...
function init() {
	...
	findIDBtn.addEventListener("click", function(e) {
		...
		if (result) {
			...
			// 2) 서버응답처리
			// XMLHttpRequest.readyState 값에대한 정의 Holds the status of the
			// XMLHttpRequest.
			...
			// 4: 서버가 클라이언트의 요청을 완료했고 서버도 응답이 완료된 상태 request finished and response is
			// ready
